# DVR Source Attachments

This directory contains small, readable source files connected to the DVR note
series. The notebooks and large binary artifacts remain outside the published
site. The main executable entry points are one level above this directory:
